...
def get_embedding_provider(settings: Settings) -> EmbeddingProvider:
    ...
    if p == "openai":
        from agent.infrastructure.providers.embeddings.openai import OpenAIEmbeddingProvider
    ...
    if p == "ollama":
        from agent.infrastructure.providers.embeddings.ollama import OllamaEmbeddingProvider
    ...
    if p == "local":
        from agent.infrastructure.providers.embeddings.local import LocalEmbeddingProvider
